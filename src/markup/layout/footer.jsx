						...
						<div className="footer-bottom">
							<div className="row">
								<div className="col-12 text-center">
									<p className="copyright-text">Copyright © 2023 Design & Developed by <a href="https://unitdtechnologies.com/" rel="noreferrer" target="_blank" className="text-secondary">UTS</a></p>
								</div>
							</div>
						</div>
					</div>
